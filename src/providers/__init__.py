...
def get_provider(provider: str = None, model_name: str = None, api_key: str = None) -> BaseProvider:
    """
...
async def get_provider_by_model(model_name: str, api_key: str = None) -> BaseProvider:
    ...
    return get_provider(provider=mapping.provider_type, api_key=api_key)
