<template>
  <el-container class="main-layout">
    <!-- Desktop sidebar -->
    <el-aside width="230px" class="main-layout__aside hidden md:flex">
      <nav class="flex h-full w-full flex-col border-r border-border-dark/50 bg-white/90 backdrop-blur-xl">
        <!-- Logo -->
              ...
              <router-link
                ...
                :class="[
                  ...
                  isActive(item.to)
                    ...
                    : 'text-ink-700 hover:bg-primary/5 border-l-[3px] border-transparent'
                ]"
              >
        ...
        <div class="flex-1 min-h-0 overflow-hidden">
          <ChatHistorySidebar v-if="authStore.isAuthenticated" @collapse="() => {}" />
        </div>
        ...
        <div class="shrink-0 border-t border-border-dark px-3 py-2 space-y-0.5">
          <router-link
            ...
            :class="[
              ...
              isActive('/pricing') ? 'bg-primary/15 text-primary font-semibold border-l-[3px] border-primary' : 'text-ink-700 hover:bg-primary/5 border-l-[3px] border-transparent'
            ]"
          >
